...
export function getVerificationEmailTemplate(
  ...
  const expirationWindow = '24 horas';
      ...
      <head>
        ...
        <style>
          ...
          .header-chip {
            ...
            border: 1px solid rgba(60, 172, 59, 0.45);
            color: #ecfdf3;
            font-size: 13px;
            font-weight: 600;
              ...
              <table role="presentation" class="email-card" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="header">
                    ...
                    <span class="header-chip">Activa tu cuenta</span>
                    <h1 class="header-title">Verifica tu email</h1>
                    <p class="header-subtitle">Confirma tu dirección y desbloquea las ligas privadas.</p>
                  </td>
                </tr>
                <tr>
                  <td class="content">
                    ...
                    <div class="callout callout-success">
                      <p class="callout-title">¿Qué ocurre después?</p>
                      <p class="callout-text">Tras validar tu email podrás crear ligas privadas, compartir invitaciones y gestionar tu clasificación en vivo.</p>
                    </div>
                    <p class="body-small">Si el botón no funciona, usa el enlace directo:</p>
                    <p class="link-block">
                      <a href="${verificationUrl}">${verificationUrl}</a>
                    </p>
                    <p class="body-small">
                      Si no solicitaste este registro, ignora y borra el correo para mantener la seguridad.
                    </p>
                  </td>
                </tr>
                <tr>
