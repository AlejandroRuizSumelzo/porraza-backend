...
export function getWelcomeEmailTemplate(name: string): string {
  ...
  const welcomeDate = new Date().toLocaleString('es-ES', {
              ...
              <table role="presentation" class="email-card" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="header">
                    ...
                    <span class="header-chip">Cuenta activada</span>
                    <h1 class="header-title">¡Bienvenido a la liga!</h1>
                    <p class="header-subtitle">Empieza a organizar tus pronósticos y comparte la emoción con tu equipo.</p>
                  </td>
                </tr>
                <tr>
                  <td class="content">
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" class="meta-grid">
                      <tr>
                        <td>
                          <div class="meta-card">
                            <p class="meta-label">Activación</p>
                            <p class="meta-value">${welcomeDate}</p>
                          </div>
                        </td>
                        <td>
                          <div class="meta-card">
                            <p class="meta-label">Estado de la cuenta</p>
                            <p class="meta-value">Verificada ✅</p>
                          </div>
                        </td>
                      </tr>
                    </table>
                    <div class="highlights">
                      ...
                      <ul>
                        ...
                        <li>Personalizar reglas y ver las predicciones de tu colega.</li>
                      </ul>
                    </div>
                    <div class="cta-wrapper">
                      <a href="${frontendUrl}/login" class="cta-button">Iniciar sesión</a>
                    </div>
                    <p class="body-small">¿Que aún no has entrado? Guarda este enlace para entrar desde cualquier dispositivo.</p>
                    <p class="closing">
